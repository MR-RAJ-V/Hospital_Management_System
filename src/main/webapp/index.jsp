...
<div class="container p-3">
  ...
  <div class="row">
    ...
    <!-- Right Column -->
    <div class="col-md-4">
      <img src="img/doc.jpg" alt="Doctor Image" class="img-fluid rounded shadow-sm">
    </div>
  </div>
</div>
...
<div class="container p-2">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="card paint-card">
        <div class="card-body text-center">
          <img src="img/doc4.jpg" width="250px" height="300px"  alt="Samuani Simi">
    ...
    <div class="col-md-3">
      <div class="card paint-card">
        <div class="card-body text-center">
          <img src="img/doc2.jpg" width="250px" height="300px" class="img-fluid rounded mb-3" alt="Dr. Siva Kumar">
    ...
    <div class="col-md-3">
      <div class="card paint-card">
        <div class="card-body text-center">
          <img src="img/doc3.jpg" width="250px" height="300px" class="img-fluid rounded mb-3" alt="Dr. Niuise Paule">
    ...
    <div class="col-md-3">
      <div class="card paint-card">
        <div class="card-body text-center">
          <img src="img/doc1.jpg" width="250px" height="300px"  alt="Dr. Mathue Samuel">
