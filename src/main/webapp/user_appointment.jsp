...
.backImg {
	...
	height: 20vh;
	width: 100%;
	background-size: cover; /* Added missing styles */
	background-repeat: no-repeat; /* Added missing styles */
}
</style>
</head>
<body>
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="img/doc1.jpg" class="img-fluid">
			</div>
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<%-- The following email field was a duplicate and has been removed --%>
							<%-- 
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Email</label> 
								<input required type="email" class="form-control" name="email">
							...
							<div class="col-md-6">
								...
								<select required class="form-control" name="doct">
									<option value=""> -- select --</option>
                                     ...
                                     %>
									<%-- This is where a loop to populate doctor options (from 'List<Doctor>' or similar) would typically go --%>
	...
	<%-- Assuming a footer component is next --%>
